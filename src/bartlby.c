...
PHP_MINIT_FUNCTION(bartlby)
{
	...
	REGISTER_LONG_CONSTANT("BARTLBY_AUDIT_TYPE_TRIGGER", BARTLBY_AUDIT_TYPE_TRIGGER, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("BARTLBY_OBJECT_SERVICE", BARTLBY_OBJECT_SERVICE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BARTLBY_OBJECT_SERVER", BARTLBY_OBJECT_SERVER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BARTLBY_OBJECT_WORKER", BARTLBY_OBJECT_WORKER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BARTLBY_OBJECT_DOWNTIME", BARTLBY_OBJECT_DOWNTIME, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("TRIGGER_TYPE_SMTP", TRIGGER_TYPE_SMTP, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TRIGGER_TYPE_LUA", TRIGGER_TYPE_LUA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TRIGGER_TYPE_WEBHOOKS", TRIGGER_TYPE_WEBHOOKS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TRIGGER_TYPE_LOCAL", TRIGGER_TYPE_LOCAL, CONST_CS | CONST_PERSISTENT);
