srcdir = /root/bartlby-php
builddir = /root/bartlby-php
top_srcdir = /root/bartlby-php
top_builddir = /root/bartlby-php
EGREP = /bin/grep -E
SED = /bin/sed
...
prefix = /usr
phplibdir = /root/bartlby-php/modules
...
.NOEXPORT:
bartlby.lo: /root/bartlby-php/bartlby.c
	$(LIBTOOL) --mode=compile $(CC)  -I. -I/root/bartlby-php $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)  -c /root/bartlby-php/bartlby.c -o bartlby.lo 
$(phplibdir)/bartlby.la: ./bartlby.la
	$(LIBTOOL) --mode=install cp ./bartlby.la $(phplibdir)

./bartlby.la: $(shared_objects_bartlby) $(BARTLBY_SHARED_DEPENDENCIES)
	$(LIBTOOL) --mode=link $(CC) $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS) -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_bartlby) $(BARTLBY_SHARED_LIBADD)
